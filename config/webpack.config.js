...
const isAnalyz = process.env.MODE_ENV === "analyz";
...
module.exports = function(webpackEnv) {
	...
	return {
		...
		resolve: {
			...
			alias: {
				//解决antd icons导入包体积过大问题
				//"@ant-design/icons/lib/dist$": path.resolve(paths.appSrc, "utils/icons.ts"),
				"@": paths.appSrc,
				"@cmp": path.resolve(paths.appSrc, "components"),
				"@ctn": path.resolve(paths.appSrc, "containers")
			},
			plugins: [
			...
			mainFiles: ["index.js", "index.tsx", "index.ts", "index.jsx"]
		},
		resolveLoader: {
			plugins: [
		...
		plugins: [
			...
			isAnalyz && new BundleAnalyzerPlugin()
		].filter(Boolean),
