...
//根据项目名修改资源文件路径
process.env.PUBLIC_URL = "//s1.xmcdn.com/sr012018/brand-radio-web/last/dist";
process.env.GENERATE_SOURCEMAP = false;
if (process.env.MODE_ENV === "test") {
	process.env.GENERATE_SOURCEMAP = true;
	process.env.PUBLIC_URL = "//static2.test.ximalaya.com/sr012018/brand-radio-web/last/dist";
}
